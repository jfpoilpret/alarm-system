...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/wificheck.exe: ../arduino_cosa_111_lib/dist/UNO-Release/Arduino-1.6.6-Cosa-1.1.1-Windows/libarduino_cosa_111_lib.a
...
${OBJECTDIR}/Camera.o: Camera.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -Wall -I../../../Cosa/cores/cosa -I../../../Cosa/variants/${VARIANT} -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Camera.o Camera.cpp

${OBJECTDIR}/WiFiCheck.o: WiFiCheck.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -Wall -I../../../Cosa/cores/cosa -I../../../Cosa/variants/${VARIANT} -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WiFiCheck.o WiFiCheck.cpp

${OBJECTDIR}/WiFiEsp.o: WiFiEsp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -Wall -I../../../Cosa/cores/cosa -I../../../Cosa/variants/${VARIANT} -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WiFiEsp.o WiFiEsp.cpp
