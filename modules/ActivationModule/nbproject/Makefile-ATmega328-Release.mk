...
LDLIBSOPTIONS=../arduino_cosa_lib/dist/ATmega328-Release/Arduino-1.6.6-Windows/libarduino_cosa_lib.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/activationmodule.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/activationmodule.exe: ../arduino_cosa_lib/dist/ATmega328-Release/Arduino-1.6.6-Windows/libarduino_cosa_lib.a
...
# Subprojects
.build-subprojects:
	cd ../arduino_cosa_lib && ${MAKE}  -f Makefile CONF=ATmega328-Release
...
# Subprojects
.clean-subprojects:
	cd ../arduino_cosa_lib && ${MAKE}  -f Makefile CONF=ATmega328-Release clean
