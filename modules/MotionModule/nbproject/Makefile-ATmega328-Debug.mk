...
# CC Compiler Flags
CCFLAGS=-mmcu=${MCU} -DF_CPU=${F_CPU} -DARDUINO=${ARDUINO} -fno-exceptions -Wextra -flto -std=gnu++11 -felide-constructors -O0 -g -ffunction-sections -fdata-sections -DNO_CIPHER
CXXFLAGS=-mmcu=${MCU} -DF_CPU=${F_CPU} -DARDUINO=${ARDUINO} -fno-exceptions -Wextra -flto -std=gnu++11 -felide-constructors -O0 -g -ffunction-sections -fdata-sections -DNO_CIPHER
...
LDLIBSOPTIONS=../arduino_cosa_111_lib/dist/ATmega328-Debug/Arduino-1.6.6-Cosa-1.1.1-Windows/libarduino_cosa_111_lib.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/motionmodule.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/motionmodule.exe: ../arduino_cosa_111_lib/dist/ATmega328-Debug/Arduino-1.6.6-Cosa-1.1.1-Windows/libarduino_cosa_111_lib.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/motionmodule.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/motionmodule ${OBJECTFILES} ${LDLIBSOPTIONS} -Os -Wl,--gc-sections -Wl,-relax -flto -mmcu=${MCU} -lm
...
# Subprojects
.build-subprojects:
	cd ../arduino_cosa_111_lib && ${MAKE}  -f Makefile CONF=ATmega328-Debug
...
# Subprojects
.clean-subprojects:
	cd ../arduino_cosa_111_lib && ${MAKE}  -f Makefile CONF=ATmega328-Debug clean
