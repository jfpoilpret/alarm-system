...
${OBJECTDIR}/Cipher.o: Cipher.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cipher.o Cipher.cpp

${OBJECTDIR}/Commands.o: Commands.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands.o Commands.cpp

${OBJECTDIR}/Handlers.o: Handlers.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Handlers.o Handlers.cpp

${OBJECTDIR}/NRF24L01P.o: NRF24L01P.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NRF24L01P.o NRF24L01P.cpp

${OBJECTDIR}/RFManager.o: RFManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RFManager.o RFManager.cpp
...
${TESTDIR}/tests/XTEATest.o: tests/XTEATest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/XTEATest.o tests/XTEATest.cpp


${TESTDIR}/tests/testrunner.o: tests/testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testrunner.o tests/testrunner.cpp
...
${OBJECTDIR}/Cipher_nomain.o: ${OBJECTDIR}/Cipher.o Cipher.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cipher_nomain.o Cipher.cpp;\
	else  \
...
${OBJECTDIR}/Commands_nomain.o: ${OBJECTDIR}/Commands.o Commands.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Commands_nomain.o Commands.cpp;\
	else  \
...
${OBJECTDIR}/Handlers_nomain.o: ${OBJECTDIR}/Handlers.o Handlers.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Handlers_nomain.o Handlers.cpp;\
	else  \
...
${OBJECTDIR}/NRF24L01P_nomain.o: ${OBJECTDIR}/NRF24L01P.o NRF24L01P.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NRF24L01P_nomain.o NRF24L01P.cpp;\
	else  \
...
${OBJECTDIR}/RFManager_nomain.o: ${OBJECTDIR}/RFManager.o RFManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RFManager_nomain.o RFManager.cpp;\
	else  \
